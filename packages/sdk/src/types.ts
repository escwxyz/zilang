...
export type TypedCollectionSelect<T extends PayloadGeneratedTypes> =
	T["collectionsSelect"];

export type TypedCollectionJoins<T extends PayloadGeneratedTypes> =
	T["collectionsJoins"];

export type TypedGlobalSelect<T extends PayloadGeneratedTypes> =
	T["globalsSelect"];

export type TypedAuth<T extends PayloadGeneratedTypes> = T["auth"];

export type CollectionSlug<T extends PayloadGeneratedTypes> = StringKeyOf<
	TypedCollection<T>
>;

export type GlobalSlug<T extends PayloadGeneratedTypes> = StringKeyOf<
	TypedGlobal<T>
>;

export type AuthCollectionSlug<T extends PayloadGeneratedTypes> = StringKeyOf<
	TypedAuth<T>
>;
...
export type TypedLocale<T extends PayloadGeneratedTypes> = NonNullable<
	T["locale"]
>;
...
export type PopulateType<T extends PayloadGeneratedTypes> = Partial<
	TypedCollectionSelect<T>
>;
